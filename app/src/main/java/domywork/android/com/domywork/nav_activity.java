...
public class nav_activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabImageButton = (FloatingActionButton) findViewById(R.id.fabcorrect);
        fabImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nav_activity.this,Post_activity.class));
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_helpers) {

        } else if (id == R.id.nav_seekers) {
